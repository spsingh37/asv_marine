...
def launch(context, *args, **kwargs):
    ...
    # Add static transform publisher to publish the world->base_link transform
    ...
    dynamic_tf_broadcaster = Node(
        package='vrx_gz',  # The package name
        executable='dynamic_tf_broadcaster.py',  # The script name
        name='dynamic_tf_broadcaster',
        output='screen',
        parameters=[],
    )
    
    launch_processes.append(dynamic_tf_broadcaster)
